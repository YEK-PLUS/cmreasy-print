...
export const SenderInstructions: FC<SenderInstructionsProps> = ({ data: _data, language, mode }) => {
    const data = typeCheck(sendersInstructionsSchema, _data)
    return <Box title="senderInstructions.title" language={language} mode={mode} order={13} wrapperStyle={{ flex: 1 }}>
