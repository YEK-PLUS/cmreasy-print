...
import { PlaceAndDateOfTakingOverTheGoodsType, placeAndDateOfTakingOverTheGoodsSchema } from "../types";
...
export const PlaceAndDateOfTakingOverTheGoods: React.FC<PlaceAndDateOfTakingOverTheGoodsProps> = ({ data: _data, language, mode }) => {
    const data = typeCheck(placeAndDateOfTakingOverTheGoodsSchema, _data)
    const { takeCity, takeCountry, takeDate } = data

    return (
        <Box title="placeAndDateOfTakingOverTheGoods.title" language={language} mode={mode} order={4}>
